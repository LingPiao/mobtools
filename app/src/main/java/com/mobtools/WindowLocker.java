...
public class WindowLocker {
	...
	public static void wakeup(Activity activity) {
		LogUtil.d("WnidowLocker wake up the phone from sleep...");
		Window window = activity.getWindow();
		window.addFlags(LayoutParams.FLAG_DISMISS_KEYGUARD);
		window.addFlags(LayoutParams.FLAG_SHOW_WHEN_LOCKED);
		window.addFlags(LayoutParams.FLAG_TURN_SCREEN_ON);
		LogUtil.d("WnidowLocker wakeup finished");
	}

	public static void releaseWakeup(Activity activity) {
		LogUtil.d("WnidowLocker clear flags from window...");
		Window window = activity.getWindow();
		...
		LogUtil.d("WnidowLocker clear flags finished");
	}
}
