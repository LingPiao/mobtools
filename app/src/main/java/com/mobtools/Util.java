...
public class Util {
    ...
    public static String encodeURLWithUTF8(String str) {
        try {
            ...
            LogUtil.w("Encoding city exception:" + e.getMessage());
        }
        return str;
    }
    ...
    public static void printPhoneInfo() {
        LogUtil.d("Phone info:");
        LogUtil.d("DeviceName:" + getDeviceName());
        LogUtil.d("Android version:" + getAndroidVer());
    }
    ...
    public static boolean executeCommandViaSu(String command) {
        ...
        try {
            LogUtil.d("Execute the cmd[" + su + " -c " + command + "]...");
            // Execute command as "su".
            Runtime.getRuntime().exec(new String[]{su, "-c", command});
        } catch (IOException e) {
            success = false;
            LogUtil.w("Oops! Cannot execute the cmd for some reason:" + e.getMessage());
        } finally {
            success = true;
            LogUtil.d("Execute the cmd successfully.");
        }
        return success;
    }
    ...
    public static boolean executeCommand(String command) {
        boolean success = false;
        try {
            LogUtil.d("Execute the cmd[" + command + "]...");
